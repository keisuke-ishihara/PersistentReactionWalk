%% compare the V-r plots for polymer, dying particle and diffusion limit
clear all;
...
fcat = 1;
fres = 1;
d = v2*fcat/v1-fres; % this matches particles with death vs. polymer
...
mytitle = '$d_{+}=0,\,\,d_{-}=\frac{v_{-}f_{+}}{v_{+}}-f_{-}$';
title(mytitle,'Interpreter', 'latex')

% saveas(FigHandleVr,'plotVr_comparePolymerParticleDiffusion.eps','epsc2')
