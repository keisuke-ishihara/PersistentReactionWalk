function [r_critical, v_theoretical, J, K] = theoretical_returnsK( v1,v2,fcat,fres,r )

%% returns the velocity and spatial decay of front produced by the replicating particles r_{++} only
